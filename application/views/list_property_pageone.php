                ...
                <form class="login100-form validate-form" method="post" action="">
                    ...
                    <div class="col-md-12">
                        <select class="selectpicker" title="choose one">
                            ...
                            <option value="car or truck">car or truck</option>
                        </select>
                    </div>
                    <br><br>
                    <div class="col-md-12">
                        <p><b># number of units managed?</b></p>
                    </div>
                    <div class="col-md-12">
                        <select class="selectpicker" title="# no of units">
                    ...
                    <br><br>
                    <div class="col-md-12">
                        <p><b>how many total rooms?</b></p>
                    </div>
                    <div class="col-md-12">
                       <input type="text"  name = "noofrooms" placeholder="# of rooms" />
                    </div>
                    ...
                    <div class="col-md-14 p-t-20">
                        <a href="list_property_pagetwo"><img id="img4" src="<?php echo base_url(); ?>assets/images/logos-34.png" style="width:10%; height:10%; margin-left:85%;" /></a>
