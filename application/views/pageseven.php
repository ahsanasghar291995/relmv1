    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.back').click(function() {
                ...
                window.location.href = "<?php echo base_url(); ?>index.php/main/screenthree";
            ...
            <div class="wrap-login100 p-l-25 p-r-25 p-t-20 p-b-24">
                <div class="top">
                    ...
                    <ul class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; transform: translate3d(0px, 38px, 0px);">
                        ...
                        <li><a class="dropdown-item" href="list_property_finalpage" style="color:gray;">property lister</a></li>
                         <li><a class="dropdown-item" href="car_lister" style="color:gray;">car lister</a></li>
                        
                        <li><a class="dropdown-item" href="cowork_lister" style="color:gray;">cowork lister</a></li>
                ...
                <form class="login100-form validate-form" method="post" action="matching">
                    ...
                    <div class="col-md-14" style="border:2px solid gray; border-radius:10px; color:gray; font-size:20px; text-align:center;">
                        <img src="<?php echo base_url(); ?>assets/images/social_space_icon1.svg" style="width:50px; float:right; padding-top:10px; padding-right:10px;" />
                        <br>
                        <p><strong style="color:gray; padding-left:52px;">professionals</strong></p><br>
                    ...
                    -->
                    <div class="col-md-14" style="border:2px solid gray; border-radius:10px; color:gray; font-size:20px; text-align:center;">
                        <img src="<?php echo base_url(); ?>assets/images/social_space_icon2.svg" style="width:50px; float:right; padding-top:10px; padding-right:10px;" />
                        <br>
                        <p><strong style="color:gray; padding-left:47px;">housemates</strong></p><br>
                        <div class="col-md-14 thumbnail" style="justify-content:space-between;">
                    ...
                    <br>
                    <div class="col-md-14" style="border:2px solid gray; border-radius:10px; color:gray; font-size:20px; text-align:center;">
                        <br><br><br><p><strong style="color:gray;">+  /  -  skills</strong></p><br><br><br>
                    ...
                    <br>
                    <div class="col-md-14" style="border:2px solid gray; border-radius:10px; color:gray; font-size:20px; text-align:center;">
                        <br><br><br><p><strong style="color:gray;">shared experiences</strong></p><br><br><br>
                    </div>
                    <br>
                    <!--
                    <div class="col-md-14" style="border:2px solid gray; border-radius:10px; color:gray; ">
                        <img src="<?php echo base_url(); ?>assets/images/social_space_icon1.svg" style="width:50px; float:right; padding-top:10px; padding-right:10px;" />
                        <br>
                        <p style="text-align:center;"><strong style="color:gray; padding-left:50px;">gigs to consider</strong></p><br>
                    ...
                    <div class="col-md-14" style="border:2px solid gray; border-radius:10px; color:gray; font-size:20px; text-align:center;">
                        <img src="<?php echo base_url(); ?>assets/images/social_space_icon1.svg" style="width:50px; float:right; padding-top:10px; padding-right:10px;" />
                        <br>
                        <p><strong style="color:gray; padding-left:47px;">workroom</strong></p><br>
