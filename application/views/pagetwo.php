        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-25 p-r-25 p-t-20 p-b-24">
                ...
                <form class="login100-form validate-form" method="post" action="update_records_pagetwo">
                    ...
                    <div class="items">
                        <select class="selectpicker" name="cleanliness" title="cleanliness" style="width:100%; border:none; color:gray;">
                            <!-- <option value="">Pets</option> -->
                    ...
                    <div class="items">
                        <select class="selectpicker" name="noise_level" title="noise level" style="width:100%; border:none; color:gray;">
                            ...
                            <option value="I'm loud/play an instrument">I'm loud/play an instrument</option>
                        </select>
                    </div>
                    <div class="items">
                  ...
                  <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%; background-color:gray;">
