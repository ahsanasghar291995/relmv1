    ...
    <div class="limiter hello4" id="img14">
        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-25 p-r-25 p-t-15 p-b-15">
                <div class="top">
                    <a href="list_property_pagefour"><img id="img3" src="<?php echo base_url(); ?>assets/images/logos-33.png" style="width:10%; height:100%; "></a></img>
                ...
                <form class="login100-form validate-form" method="post" action="">
                    ...
                    <br>
                    <div class="col-md-6" style="display:flex; border-bottom: 1px solid #aaa; width:70%;">
                    ...
                    <br>
                    <br>
                    <iframe width="100%" height="300" src="https://maps.google.com/maps?q=California&output=embed">
                    </iframe>
