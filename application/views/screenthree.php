...
<body class="container-login10">
    ...
    <div class="" id="img14">
        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-25 p-r-25 p-t-20 p-b-24" style="background:lightgray;">
                <div class="top">
                ...
                <form class="login100-form validate-form" method="post" action="pageseven">
                    ...
                    <div class="col-md-12">
                        <p style="color:gray; text-align:center; font-size:20px;">welcome to launchpad</p>
                    </div>
                    <br>
                    <br>
                    <div class="col-md-12">
                        <p style="color:gray; text-align:center; font-size:16px; text-align:center;">the purpose of this dashboard is to add/edit/delete matching inputs for housemates experiences</p>
                    </div>
                    <br><br><br>
                    ...
                    <div class="flex-col-c p-t-30">
                        ...
                        <div class="bottom">
                            ...
                            <img id="" src="<?php echo base_url(); ?>assets/images/Relm-52.png" class="bottom redirect" style="width:25%; height:20%; margin-top:20px;" class="wow" />
