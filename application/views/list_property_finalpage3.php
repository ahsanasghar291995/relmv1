    ...
    <div>
        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-25 p-r-25 p-t-15 p-b-15">
                ...
                <form class="login100-form validate-form" method="post" action="update_cowork" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        <h3 style="text-align:center;">cowork lister</h3>
                    </div>

                    <br>
                    <div class="col-md-12" style="display:flex; justify-content:space-between;">
                        <img id="img33" src="<?php echo base_url(); ?>assets/images/backlogo.png" onClick="window.location='<?php echo base_url(); ?>index.php/main/list_property_finalpage2'" style="width:10%; height:100%;"></img>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <div class="col-md-12" style="display:flex; justify-content:space-between;">
                                    <p>sq.feet</p>
                                    <input type="text" name="cowork_sq_feet" style="width:30%; color:gray; border:1px solid gray;"></input>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <div class="col-md-12" style="display:flex; justify-content:space-between;">
                                    <p># of desks</p>
                                    <input type="text" name="cowork_desks" style="width:30%; color:gray; border:1px solid gray;"></input>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12" style="display:flex; justify-content:space-between;">
                                <select class="selectpicker" title="conf-room" name="cowork_conf_room">
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
                                </select>
                                <select class="selectpicker" title="pets" name="cowork_pets">
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
                                </select>
                                <select class="selectpicker" title="restroom" name="cowork_restroom">
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
                                </select>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <select class="selectpicker" title="shared office" name="cowork_shared_office">
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
                                </select>
