    ...
    <div class="" id="img14">
        <div class="container-login100">
            <div class="wrap-login100 p-l-55 p-r-55">
                <form class="login100-form validate-form" method="post" action="send_mail">
                    <span class="login100-form-title p-b-50">
                        <img id="" stylw="p-l-20 p-t-10" src="<?php echo base_url(); ?>assets/images/Relm-53.png" style="width:20%;" />
                    </span>
                    <br><br><br><br><br>
                    <div class="wrap-input100 validate-input m-b-23" style="background-color:#F8F8F8; border-radius:5px;" data-validate="email is reauired">
                    ...
                    <button class="login100-form-btn" style="background-color:#F8F8F8; border-radius:5px;">
                        <a href="check_update_password" style="color:black; text-transform: lowercase;">confirm</a>
                    </button>
