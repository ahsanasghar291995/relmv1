        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-25 p-r-25 p-t-20 p-b-24">
                ...
                <form class="login100-form validate-form">
                    ...
                    <div class="items">
                        <p>lifestyle & entertainment</p>
                        <img id="img6" src="<?php echo base_url(); ?>assets/images/logos-88.png" style="width:10%; height:10%; " />
                    </div>
                    <div class="items">
                        <p>education & student life</p>
                    ...
                    <div class="flex-col-c p-t-30">
                        <a href="pagefour"><img id="img4" src="<?php echo base_url(); ?>assets/images/logos-34.png" style="width:10%; height:10%; margin-left:85%;" /></a>
