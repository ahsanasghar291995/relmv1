    ...
    <div class="limiter hello4" id="img14">
        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-25 p-r-25 p-t-15 p-b-15">
                <div class="top">
                    <a href="list_property_pagethree"><img id="img3" src="<?php echo base_url(); ?>assets/images/logos-33.png" style="width:10%; height:100%; "></a></img>
                ...
                <form class="login100-form validate-form" method="post" action="">
                    ...
                    <br>
                    <div class="col-md-12">
                        <select class="selectpicker" title="select monthly rate">
                    ...
                    <br>
                    <div class="col-md-12">
                        <select class="selectpicker" title="preferred duration">
                            <option value="1-3 months">1-3 months</option>
                            <option value="3-6 months">3-6 months</option>
                            <option value="6-9 months">6-9 months</option>
                            <option value="9-12 months">9-12 months</option>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12" style="display:flex; justify-content:space-between;">
                            <img src="<?php echo base_url(); ?>assets/images/house-4.jpeg" style="width:20%; height:20%;"></img>
                            <img src="<?php echo base_url(); ?>assets/images/house-2.jpg" style="width:20%; height:20%;"></img>
                            <img src="<?php echo base_url(); ?>assets/images/house-3.jpg" style="width:20%; height:20%;"></img>
                            <i class="fa fa-plus fa-2x" style="color:gray; padding-top:5px;"></i>
                        </div>
                    </div>
                    ...
                    <br><br>
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="5" aria-valuemin="0" aria-valuemax="100" style="width:70%">
                    ...
                    <div class="col-md-14 p-t-20">
                        <a href="list_property_pagefive"><img id="img4" src="<?php echo base_url(); ?>assets/images/logos-34.png" style="width:10%; height:10%; margin-left:85%;" /></a>
