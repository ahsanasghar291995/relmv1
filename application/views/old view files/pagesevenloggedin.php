    ...
    <div class="limiter hello4" id="img14">
        ...
        <div class="container-login100">
            ...
            <div class="wrap-login100 p-l-25 p-r-25 p-t-20 p-b-24">
                <div class="col-md-14 navbar">
                    <img id="img3" class="back" src="<?php echo base_url(); ?>assets/images/logos-33.png" style="width:10%;"></img>
                ...
                <form class="login100-form validate-form" method="post" action="">
                    ...
                    <div class="col-md-14" style="color:gray; font-size:20px; text-align:center;">
                        ...
                        <br>
                        <br>
                        <p><strong style="color:gray;">.care</strong></p>
                    </div>
                    <br>
                    <div class="col-md-14" style="border:2px solid gray; border-radius:10px; color:gray; font-size:20px; text-align:center;">
                        <br>
                        <p><strong style="color:blue;">professionals</strong></p><br>
                        <div class="col-md-14 thumbnail" style="justify-content:space-between;">
                            <img id="img33" class="back" src="<?php echo base_url(); ?>assets/images/logos-33.png" style="width:10%;"></img>
                            <img src="<?php echo base_url(); ?>/assets/images/girl2.png" style="width:20%;"></img>
                            <img id="img4" src="<?php echo base_url(); ?>assets/images/logos-34.png" style="width:10%;" />
                        </div>
                        <br>
                        <p>32</p>
                        <p>86% match</p>
                    ...
                    <div class="col-md-14" style="border:2px solid gray; border-radius:10px; color:gray; font-size:20px; text-align:center;">
                        <br>
                        <p><strong style="color:blue;">housemates</strong></p><br>
                        <div class="col-md-14 thumbnail" style="justify-content:space-between;">
                            <img id="img333" src="<?php echo base_url(); ?>assets/images/logos-33.png" style="width:10%;"></img>
                            <img src="<?php echo base_url(); ?>/assets/images/girl2.png" style="width:20%;"></img>
                            <img id="img444" src="<?php echo base_url(); ?>assets/images/logos-34.png" style="width:10%;" />
                        </div>
                        <br>
                        <p>32</p>
                        <p>personal preferences</p>
                        <p>living preferences</p>
                    ...
                    <div class="col-md-14" style="border:2px solid gray; border-radius:10px; color:gray; font-size:20px; text-align:center;">
                        <br>
                        <p><strong style="color:blue;">shared experiences</strong></p><br>
                    ...
                    <div class="col-md-14" style="border:2px solid gray; border-radius:10px; color:gray; ">
                        <br>
                        <p style="text-align:center;"><strong style="color:blue;">gigs to consider</strong></p><br>
                    ...
                    <div class="flex-col-c p-t-30">
                        ...
                        <div class="bottom">
                            ...
                            <img id="img2" src="<?php echo base_url(); ?>assets/images/logos-29.png" class="bottom" style="width:50%; height:50%; margin-top:20px; margin-left:15px;" class="wow" />
                            <img id="img5" src="<?php echo base_url(); ?>assets/images/logos-41.png" class="bottom" style="width:15%; height:15%; margin-top:20px;" />
                        </div>
                    </div>
                </form>
            </div>
