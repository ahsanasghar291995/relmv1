    ...
    <div class="limiter hello4" id="img14">
        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-25 p-r-25 p-t-15 p-b-15">
                <div class="top">
                    <a href="list_property_pageone"><img id="img3" src="<?php echo base_url(); ?>assets/images/logos-33.png" style="width:10%; height:100%; "></a></img>
                ...
                <form class="login100-form validate-form" method="post" action="">
                    ...
                    <div class="col-md-12">
                        <p><b>is this a home, apartment, etc?</b></p>
                    </div>
                    <div class="col-md-12">
                        <select class="selectpicker" title="home">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        </select>
                    ...
                    <div class="col-md-14" style="display:flex;">
                        ...
                        <div class="col-md-4">
                            <select class="selectpicker" title="sq."></select>
                        </div>
                    </div>
                    <br><br>
                    <div class="col-md-12">
                        <p><b>is the listing furnished?</b></p>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-14 p-t-20">
                        <a href="list_property_pagethree"><img id="img4" src="<?php echo base_url(); ?>assets/images/logos-34.png" style="width:10%; height:10%; margin-left:85%;" /></a>
